...
RSpec.describe 'Scores', type: :request do
  ...
  let!(:score1) {
    create(:score, user_id: user1.id, music_id: music.id, difficulty: :hard, points: 700_000, platform: :board)
  }
  let!(:score2) {
    create(:score, user_id: user1.id, music_id: music.id, difficulty: :easy, points: 900_000, platform: :board)
  }
  let!(:score3) {
  ...
  describe 'GET /api/musics/:music_id/board/ranking' do
